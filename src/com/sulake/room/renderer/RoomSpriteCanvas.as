package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_795:int = 50;
      ...
      private var var_2267:Number = -10000000;
      
      private var var_2268:Number = -10000000;
      
      private var var_2365:int = 0;
      
      private var var_540:RoomObjectCache;
      
      private var var_768:int;
      
      private var var_285:Sprite;
      
      private var var_1101:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1100 == 0)
         {
            checkMouseHits(var_1102.x,var_1102.y,MouseEvent.MOUSE_MOVE);
         }
         var_1100 = 0;
         ++var_1606;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_54.graphics.beginFill(var_2365);
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_768 != var_2266 || var_767 != var_2270)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         if(_loc6_ < var_450.length)
         {
            var_450.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_450[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_935.push(_loc12_ - _loc2_);
         if(var_935.length == const_795)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_795)
            {
               _loc13_ += var_935[_loc14_];
               _loc14_++;
            }
            var_935 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_539.length)
            {
               cleanSprite(var_539[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_539 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_321 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_321.getKey(_loc1_);
            _loc3_ = var_321.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1101 != null)
                  {
                     var_1101.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1606,geometry);
                  }
                  else
                  {
      ...
      {
         if(var_321 != null && param1 != null)
         {
            var_321.add(param2,param1);
         }
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2267 || param2 != var_2268)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_539.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_540.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_540.getObjectCache(param2);
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_768 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_767))
                  {

package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_679[_loc3_];
      ...
      {
         if(param1 == null || var_399 == null)
         {
            return null;
         }
         return var_399[param1] as IConnection;
      }
      ...
      {
         var _loc2_:Class = var_680[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_399)
         {
            _loc2_ = _loc5_;
            _loc5_;

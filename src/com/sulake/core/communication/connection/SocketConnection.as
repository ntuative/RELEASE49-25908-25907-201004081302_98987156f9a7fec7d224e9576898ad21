package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1368:int = 10000;
      ...
      private var var_664:IEncryption;
      ...
      private var var_566:IProtocol;
      
      private var var_805:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_805 = new MessageClassManager();
         var_74 = new Socket();
         var_335 = new Timer(const_1368,1);
      ...
      {
         var_335.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_665));
      ...
      {
         var_335.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_665));
      ...
      private function onConnect(param1:Event) : void
      {
         var_335.stop();
         var_1164 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_665));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_805.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_566.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_334)
         {
         ...
         if(var_664 != null)
         {
            _loc3_ = var_664.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_334)
         {
            var_334.method_15(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_336.writeByte(var_74.readUnsignedByte());
         }
      }
      ...
      {
         var_805.registerMessages(param1);
      }
      ...
      {
         var_335.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_665));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_566.getMessages(var_336,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_805.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
      ...
      {
         var_335.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_665));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_335.stop();
         var_1164 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_665));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_664 + "\n");
      }
   }
}

package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1130:uint = 1;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_792)
            {
               if(var_763 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_763.errorID,var_763);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_763);
               }
            }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1130) : uint(const_494);
      }

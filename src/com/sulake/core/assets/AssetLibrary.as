package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_631:uint = 0;
      
      public static const const_1007:String = "AssetLibraryReady";
      
      public static const const_1392:String = "AssetLibraryUnloaded";
      
      public static const const_383:String = "AssetLibraryLoaded";
      
      public static const const_1278:String = "AssetLibraryLoadError";
       
      
      private var var_535:XML;
      ...
      public function unload() : void
      {
         ...
         var_318 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1392));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_535 = _loc2_.manifest.copy();
         var_370 = _loc2_.resource;
         if(var_534)
         {
            AssetLibrary.fetchLibraryContents(this,var_535,var_370);
         }
         var_318 = true;
         dispatchEvent(new Event(AssetLibrary.const_383));
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_448[param2.url];
         if(_loc4_ != null)
         {
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1278));
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_535.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_448[loader.url];
         if(struct == null)
         {

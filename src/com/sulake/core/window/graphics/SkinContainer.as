package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_745:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_655 = new Dictionary();
         var_654 = new Dictionary();
         var_1411 = new Dictionary();
         var_1685 = new Dictionary();
         TypeCodeTable.fillTables(var_1411,var_1685);
         var_1132 = new Dictionary();
         var_1684 = new Dictionary();
         StateCodeTable.fillTables(var_1132,var_1684);
         var_466 = new Dictionary();
         var_466["skin"] = BitmapSkinRenderer;
         var_466["bitmap"] = BitmapDataRenderer;
         var_466["fill"] = FillSkinRenderer;
         var_466["text"] = TextSkinRenderer;
         var_466["shape"] = ShapeSkinRenderer;
         var_466["unknown"] = SkinRenderer;
         var_466["null"] = NullSkinRenderer;
         if(var_379 == null)
         {
            var_379 = new Array();
            var_379.push(WindowState.const_61);
            var_379.push(WindowState.const_71);
            var_379.push(WindowState.const_97);
            var_379.push(WindowState.WINDOW_STATE_SELECTED);
            var_379.push(WindowState.const_77);
            var_379.push(WindowState.const_75);
            var_379.push(WindowState.const_91);
            var_379.push(WindowState.const_84);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1132)
         {
            _loc3_.push(var_1132[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1411[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_655[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_655[param1] = new Array(SkinContainer.const_745);
         }
         var_655[param1][param2] = param3;
         if(true)
         {
            var_654[param1] = new Array(SkinContainer.const_745);
         }
         var_654[param1][param2] = param4;
      }

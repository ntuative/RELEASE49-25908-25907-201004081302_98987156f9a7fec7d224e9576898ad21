package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1473:String = "_INCLUDE";
      
      public static const const_976:String = "_EXCLUDE";
      
      public static const const_1469:String = "_TEMP";
      
      private static const const_1113:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1112:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1393:Map;
      
      protected var var_14:IWindowContext;
      
      protected var var_1394:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1115,var_1114);
         var_953 = new Dictionary();
         var_1394 = new Dictionary();
         ParamCodeTable.fillTables(var_953,var_1394);
         var_1393 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1112,"");
         return param1.replace(const_1113,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1394)
            {
               delete var_1394[_loc1_];
            }
            var_1393.dispose();
            var_1393 = null;
            var_14 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_976) == -1)
                  {

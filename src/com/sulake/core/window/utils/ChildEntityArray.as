package com.sulake.core.window.utils
{
   public class ChildEntityArray extends ChildEntityArrayReader implements IChildEntityArray
   {
      ...
      {
         swapChildren(var_28[param1],var_28[param2]);
      }
      
      public function removeChild(param1:IChildEntity) : IChildEntity
      {
         var _loc2_:int = var_28.indexOf(param1);
         if(_loc2_ < 0)
         {
            return null;
         }
      ...
      public function swapChildren(param1:IChildEntity, param2:IChildEntity) : void
      {
         ...
         {
            _loc3_ = var_28.indexOf(param1);
            if(_loc3_ < 0)
            {
               return;
            }
            _loc4_ = var_28.indexOf(param2);
            if(_loc4_ < 0)
            {
               return;
            }
            ...
            var_28.splice(_loc4_,1);
            var_28.splice(_loc3_,1);
            var_28.splice(_loc3_,0,param2);
            var_28.splice(_loc4_,0,param1);
         }
      }
      
      public function removeChildAt(param1:int) : IChildEntity
      {
         var _loc2_:IChildEntity = var_28[param1];
         if(_loc2_ != null)
         {
            var_28.splice(param1,1);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         var _loc3_:int = var_28.indexOf(param1);

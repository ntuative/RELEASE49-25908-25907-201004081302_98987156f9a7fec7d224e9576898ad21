package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1192:uint = 0;
      ...
      protected var var_634:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_390 = _loc13_.blend;
            var_542 = _loc13_.treshold;
            if(var_635 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_541 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
         ...
         if(param7 != null)
         {
            ...
            if(var_15)
            {
               var_14.invalidate(this,var_7,WindowRedrawFlag.const_73);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_122,WindowParam.const_135);
         var _loc2_:* = !testParamFlag(WindowParam.const_132,WindowParam.const_134);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_635 = param1;
         var_541 = !!var_635 ? uint(var_541 | var_1382) : uint(var_541 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1849 + "]";
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_15)
         {
            var_15 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_644,var_7);
            var_15.visible = var_351;
         }
         return var_15;
      }
      ...
      {
         var_390 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_877);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_998 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_314,this,param1));
         return param1;
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_541 = !!var_635 ? uint(param1) : uint(param1 & 16777215);
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_73);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_717))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1004;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_169:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_361,this,null));
                     if(testParamFlag(WindowParam.const_159,WindowParam.const_135))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_170,WindowParam.const_134))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_378))
                        {
                           var_8.width += 0 - 0;
                        }
                        ...
                        _param = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_259,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_416:
                  var_14.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_476);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_834,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_235,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_299:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_672,this,null));
                     if(var_8 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_373:
                  var_14.invalidate(this,var_7,WindowRedrawFlag.const_920);
                  break;
               case WindowNotifyEvent.const_431:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_470:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_14.invalidate(this,var_7,WindowRedrawFlag.const_476);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_198:
                  ...
                  break;
               case WindowNotifyEvent.const_361:
                  var_8.getRegionProperties(null,var_294);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_314:
      ...
      {
         return var_634 != null ? var_634 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_711,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_998 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_1008,this,null,true);
               update(this,_loc10_);
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1142,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_61,true);
         _loc1_.type = WindowNotifyEvent.include;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_159 && var_542 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1443,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1443,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_14.invalidate(this,param1,WindowRedrawFlag.const_73);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_61,false);
         _loc1_.type = WindowNotifyEvent.const_1251;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_294 = var_8.rectangle.clone();
               var_55.x = var_7.x;
               var_55.y = var_7.y;
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_394,this,var_8));
            }
            else
            {
               var_294.x = 0;
               ...
               var_294.width = 0;
               var_294.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_998,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_14,var_7,null,var_634,properties,var_636.concat(),_id) as WindowController;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_388;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_31 == WindowState.const_395)
         {
            return true;
         }
         var_31 = WindowState.const_395;

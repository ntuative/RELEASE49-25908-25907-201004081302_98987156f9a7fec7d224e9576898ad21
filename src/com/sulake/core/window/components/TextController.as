package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2353:Rectangle = new Rectangle();
      ...
      protected var var_544:String = "none";
      
      protected var var_637:Number;
      
      protected var var_375:Number;
      ...
      {
         return new Rectangle(var_637 * maxScrollH,var_375 * maxScrollV,width,height);
      }
      ...
      {
         var_637 = param1;
         _field.scrollH = var_637 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_833,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_354,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_354,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_502,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_502,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_66.left,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_top",var_66.top,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_right",var_66.right,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_66.bottom,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("auto_size",var_544,PropertyStruct.STRING,var_544 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_502,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_544 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_544 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_544 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_544 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }

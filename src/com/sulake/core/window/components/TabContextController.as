package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1611:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1611 == null)
         {
            var_1611 = findChildByTag(TabContextController.const_1104) as IWindowContainer;
         }
         return var_1611;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_949 == null)
         {
            var_949 = findChildByTag(TabContextController.const_1103) as ITabSelectorWindow;
            if(var_949 != null)
            {
      ...
      {
         return !!var_815 ? selector.iterator : null;
      }

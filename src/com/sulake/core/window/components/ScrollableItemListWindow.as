   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_346)
         {
            ...
            if(var_346)
            {
               var_346.addEventListener(WindowEvent.const_260,scrollBarEventProc);
               var_346.addEventListener(WindowEvent.const_229,scrollBarEventProc);
            }
         }
         return var_346;
      }
      ...
      override public function dispose() : void
      {
         if(var_346)
         {
            var_346.removeEventListener(WindowEvent.const_260,scrollBarEventProc);
            var_346.removeEventListener(WindowEvent.const_229,scrollBarEventProc);
            var_346 = null;
         }
         if(var_841)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_841)
         {
            var_841 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_841;
      }

   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_884,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_613,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_613,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            ...
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_868,onHabboClubSubscriptionChanged);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_425:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_449));
         }
      }
      ...
      private function onHabboClubSubscriptionChanged(param1:Event = null) : void
      {
         ...
         if(var_10 != null)
         {
            ...
            _container.events.dispatchEvent(new RoomWidgetHabboClubUpdateEvent(var_10.clubDays,var_10.clubPeriods,var_10.method_6,_loc2_,var_10.clubLevel));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_601);
         _loc1_.push(RoomWidgetDanceMessage.const_610);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_539);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_506);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_568);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_739);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_635);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_709);
         _loc1_.push(RoomWidgetStopEffectMessage.const_589);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1298);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_908);
         _loc1_.push(RoomWidgetToolbarMessage.const_579);
         _loc1_.push(RoomWidgetToolbarMessage.const_692);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_565);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1304);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_805);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_667);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_555);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_517);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1199);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_570));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_555:
               ...
               break;
            case RoomWidgetWaveMessage.const_601:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_610:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_539:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_506:
               if(var_10 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_709:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_904)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_221,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_635:
               ...
               if(var_10 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_894:
                        _catalog.openCatalogPage(CatalogPageName.const_1166,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_905:
                        var_10.toggleInventoryPage(InventoryCategory.const_251);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1387:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_739:
            ...
            case RoomWidgetSetToolbarIconMessage.const_854:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1395:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_908:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_667:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_579:
               ...
               if(var_195)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
                     ...
                     _container.events.dispatchEvent(new RoomWidgetHabboClubUpdateEvent(var_10.clubDays,var_10.clubPeriods,var_10.method_6,_loc12_,var_10.clubLevel));
                  }
               ...
               break;
            case RoomWidgetToolbarMessage.const_692:
            ...
            case RoomWidgetAvatarEditorMessage.const_565:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_501));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_517:

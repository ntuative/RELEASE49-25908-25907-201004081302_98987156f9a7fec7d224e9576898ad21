package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_94:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_238:
               _container.events.dispatchEvent(param1);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_427);
         _loc1_.push(AdEvent.const_448);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_94);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_238);
         return _loc1_;
      }

package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_658,RoomWidgetEcotronBoxOpenMessage.const_550,RoomWidgetEcotronBoxOpenedMessage.const_1244];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_658:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_550:

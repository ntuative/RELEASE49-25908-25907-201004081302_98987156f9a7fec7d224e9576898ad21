package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_464:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_463.length)
            {
               _loc2_ = var_463.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_463.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_651.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_463.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_651.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_518,RoomWidgetChatSelectAvatarMessage.const_728];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_518:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_145,_container.roomSession,0,"Version 25908-25907-201004081217");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_728:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_783 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_783);
            }
            if(var_464 == null)
            {
               var_462.x = 0;
               var_462.y = 0;
               var_462.z = 0;
               var_464 = _loc4_.getScreenPoint(var_462);
               var_783 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_462.x = 0;
            var_462.y = 0;
            var_462.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_462);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_464.x || _loc8_.y != var_464.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_464,_loc5_));

package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_724);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_964);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_799);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_304)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_972)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_716);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_207)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_584);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1345;
                  if(!_loc25_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1241);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_555.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_52);
            var_555.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_584);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_366);
         ...
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_567);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_557);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_629);
      ...
      public function dispose() : void
      {
         ...
         if(var_555 != null)
         {
            _loc1_ = var_555.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_555.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_392)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_660:
               ...
               break;
            case RoomWidgetUserActionMessage.const_366:
            ...
            case RoomWidgetUserActionMessage.const_429:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_567:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_557:
            ...
            case RoomWidgetPetCommandMessage.const_649:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_629:

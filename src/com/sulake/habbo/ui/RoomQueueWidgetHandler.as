package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_365:
               ...
               {
                  case RoomSessionQueueEvent.const_836:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_835) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_835) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1332) + 1;
                  }
               }
               else
               {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_684:
            ...
            case RoomWidgetRoomQueueMessage.const_561:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_836);
               break;
            case RoomWidgetRoomQueueMessage.const_646:
               if(false)
               {
      ...
      {
         return [RoomSessionQueueEvent.const_365];
      }

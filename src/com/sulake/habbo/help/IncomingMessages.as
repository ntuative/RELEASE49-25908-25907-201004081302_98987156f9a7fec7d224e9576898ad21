package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_21.tellUI(HabboHelpViewEnum.const_232,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_242,_loc6_);
      }
      ...
      {
         var_21.showUI(HabboHelpViewEnum.const_328);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_21.updateTutorial(_loc2_.hasChangedLooks,_loc2_.method_4,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_380);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_21.showUI(HabboHelpViewEnum.const_636);
         var_21.tellUI(HabboHelpViewEnum.const_636,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_294)
            {
         ...
         var_21.tellUI(HabboHelpViewEnum.const_522);
      }

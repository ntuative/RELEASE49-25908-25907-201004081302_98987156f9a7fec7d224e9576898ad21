package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_210:String = "TUI_NAME_VIEW";
      
      public static const const_86:String = "TUI_MAIN_VIEW";
      
      public static const const_309:String = "TUI_CLOTHES_VIEW";
      
      public static const const_353:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_619,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_501,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_655,onTaskDoneEvent);
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1032 = true;
         if(var_35 != null && (var_35.id == const_210 || var_35.id == const_86))
         {
            showView(const_86);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1577;
         _window.width = _loc2_.width + var_1578;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_619:
               var_1031 = true;
               if(var_35 != null && var_35.id == const_353)
               {
                  showView(const_86);
               }
               break;
      ...
      {
         var_1033 = true;
         if(var_35 != null && (var_35.id == const_309 || var_35.id == const_86))
         {
            showView(const_86);
         }
      }
      ...
      {
         return var_1033 && var_1032 && var_1031;
      }
   }
}

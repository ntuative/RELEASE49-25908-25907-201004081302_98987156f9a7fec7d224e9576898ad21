package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2189:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25908-25907-201004081217");
         var_195 = param5;
         var_102 = new Map();
         var_102.add(HabboHelpViewEnum.const_1211,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_141,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_380,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_242,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_232,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_636,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_328,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_528,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_212,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_102.add(HabboHelpViewEnum.const_864,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_522,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1578 = 0 - _loc3_.width;
         var_1577 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_269 == HabboHelpViewEnum.const_141 || false)
         {
            return;
         }
         if(var_433 == null)
      ...
      {
         return var_102.getValue(var_269);
      }
      ...
      {
         var_2188 = param1;
         var _loc2_:IHelpViewController = var_102.getValue(HabboHelpViewEnum.const_141) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_991:
               ...
               break;
            case CallForHelpResultEnum.const_870:
      ...
      {
         var _loc3_:* = null;
         if(var_269 == HabboHelpViewEnum.const_141)
         {
            return;
         }
         if(true)
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1577;
         _window.width = _loc1_.width + var_1578;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_195 != null)
            {
               var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_619));
      }

package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_811:BitmapData = null;
      ...
      private var var_812:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_364,0,0,_loc4_,var_1429,var_812,var_811));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1769 = int(_config.getKey("interstitial.interval","30000"));
         var_1767 = int(_config.getKey("interstitial.show.time","5000"));
         var_1427 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_427,0,0,param1.bitmapData,var_1768));
            var_673 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_811 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1427 > 0 && var_1428 >= var_1427)
         {
            return false;
         }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_812 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }

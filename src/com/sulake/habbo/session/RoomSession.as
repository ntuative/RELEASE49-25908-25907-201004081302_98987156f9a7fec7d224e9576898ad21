package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_977:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_306 && _connection != null)
         {
      ...
      {
         return var_977 as IUserDataManager;
      }

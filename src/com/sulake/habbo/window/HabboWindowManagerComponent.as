package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_345:uint = 3;
      ...
      private var var_1196:ProfilerOutput;
      
      private var var_690:IWindowRenderer;
      ...
      {
         return var_222[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_222[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_646 = new SkinContainer(_loc3_.content as XML,assets);
         var_690 = new WindowRenderer(var_646);
         var_222 = new Array(const_345);
         var _loc5_:int = 0;
         while(_loc5_ < const_345)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_690,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_222[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_222[const_1061];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_297,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1385,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_222[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_222.pop()).dispose();
            }
            var_222 = null;
            while(false)
            {
      ...
      {
         return var_222[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_403[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_403[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1196 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1196 = new ProfilerOutput(_loc3_,this,var_690);
               var_1195 = new ProfilerAgentTask("Update","Event processing");
      ...
      {
         return var_646.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         _loc2_ = 0;
         while(_loc2_ < const_345)
         {
            var_222[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1001)
         {
         ...
         if(WindowContext.var_1379.length > 0)
         {
            WindowContext.var_1379.flush();
         }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1258,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1316,new Date().getTime().toString());

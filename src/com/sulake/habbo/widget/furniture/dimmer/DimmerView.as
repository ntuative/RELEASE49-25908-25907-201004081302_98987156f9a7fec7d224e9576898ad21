package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_60,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1033,const_1034,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_969 = _loc2_.light;
         if(var_330 != null)
         {
            var_330.setValue(var_969);
         }
         var_381 = colors.indexOf(_loc2_.color);
         if(var_467 != null)
         {
            var_467.setSelectedColorIndex(var_381);
         }

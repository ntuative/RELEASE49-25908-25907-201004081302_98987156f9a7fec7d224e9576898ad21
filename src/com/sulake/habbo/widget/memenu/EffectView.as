   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_865 = _window.findChildByName("effect_hilite");
            var_865.visible = false;
         }
         var_867 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_866 = _window.findChildByName("loader_bar");
         if(var_866 != null)
         {
            var_414 = var_866.width;
            var_173.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_867 != null)
         {
            var_867.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_867.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }

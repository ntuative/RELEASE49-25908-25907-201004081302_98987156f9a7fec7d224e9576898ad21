package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_414:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_981 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1748 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1749 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_663 = new Timer(1000,1);
         var_663.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_803 = new Timer(5000,1);
         var_803.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_60,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _window.addEventListener(WindowEvent.const_363,onWindowMoved);
         var_1159 = true;
         var_122 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1750 = _loc2_.width + const_485 + _loc6_.width + const_1045;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1046,_loc8_.width) + const_485);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_981 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_122 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_414);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_414);
         }

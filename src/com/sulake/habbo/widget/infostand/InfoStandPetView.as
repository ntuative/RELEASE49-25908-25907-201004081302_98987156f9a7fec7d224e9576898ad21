package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1650:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1643:String = "level";
      ...
      private const const_1649:uint = 3355443;
      
      private var var_215:IBorderWindow;
      
      private const const_1647:int = 158;
      
      private const const_1645:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_174:PetCommandTool;
      
      private const const_1651:uint = 11184810;
      
      private const const_1648:String = "experience";
      ...
      private function openTrainView() : void
      {
         if(var_174 == null)
         {
            var_174 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1200.getValue(var_594) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_174.showWindow(true);
            var_174.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1643,param1.level,param1.levelMax);
         updateStateElement(const_1648,param1.experience,param1.experienceMax);
         ...
         updateWindow();
         var_594 = param1.id;
         var_1200.remove(param1.id);
         var_1200.add(param1.id,param1);
         if(var_174 && var_174.isVisible() && param1.isOwnPet)
         {
            var_174.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_174.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_174 && var_174.getPetId() == var_594)
               {
                  var_174.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_366,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1647,const_1645,false);

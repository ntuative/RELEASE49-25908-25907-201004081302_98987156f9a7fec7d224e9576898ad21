package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1658:uint = 4.282169599E9;
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_738)
         {
            return;
         }
         if(var_738 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_738) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_738 % 2) ? uint(const_1427) : uint(const_1426);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1658;
            var_738 = param1;
         }
      }

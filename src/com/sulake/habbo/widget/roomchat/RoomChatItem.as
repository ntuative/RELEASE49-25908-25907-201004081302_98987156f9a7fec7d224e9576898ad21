package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      {
         _widget.onItemMouseOut(var_1013,var_1015,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1013,var_695,var_1015,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1209 = param1.chatType;
         var_1013 = param1.userId;
         var_695 = param1.userName;
         var_1015 = param1.userCategory;
         _message = param1.text;
         var_1208 = param1.userX;
      ...
      public function renderView() : void
      {
         ...
         if(var_191 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_408 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc20_ != null)
         {
            if(var_1209 == RoomWidgetChatUpdateEvent.const_264)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_695);
            }
            else if(var_1209 == RoomWidgetChatUpdateEvent.const_249)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_695);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_346 + _loc20_.textWidth + const_485;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1013,var_1015,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1013,var_1015,_roomId,_roomCategory,param1);
      }

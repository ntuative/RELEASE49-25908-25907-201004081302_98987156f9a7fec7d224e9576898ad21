package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1049:String = "pet_inventory";
      ...
      private static const const_1051:String = "selectfurni";
      
      private static const const_1053:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_571:ParkBusDialogManager;
      
      private var var_570:IHabboToolbar;
      ...
      private var var_670:ClubEndingNotification;
      ...
      private var var_671:ClubGiftNotification;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_671 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_851)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_570)
         {
            var_570.release(new IIDHabboToolbar());
            var_570 = null;
         }
         if(_windowManager)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1280);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1764)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_856);
            var_1764 = true;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_856,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_569.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_937,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_155 || param2.type == WindowEvent.const_647)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_393.isSpaceAvailable() && false)
         {
            var_393.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_571 == null)
         {
            var_571 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_571 != null)
         {
            var_571.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_985.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_569.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1136,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_569.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1233)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_670 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_570 = IHabboToolbar(param2);
         var_570.events.addEventListener(HabboToolbarEvent.const_87,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_339.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_984);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_984);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_87)
         {
            ...
            var_393 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_808["styles"],var_808["view"],var_570);
            ...
            registerUpdateReceiver(var_393,1);
            registerUpdateReceiver(this,2);
            var_339.events.addEventListener(BadgeImageReadyEvent.const_129,onBadgeImage);
            var_570.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}

package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1562:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_201 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_60,HabboWindowStyle.const_857,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1078 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1078)
         {
         ...
         var_1327 = _loc7_.toolbar.@margin_bottom;
         var_1562 = _loc7_.toolbar.@min_group_margin;
         var_1563 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_264,param1,param2,_window,var_271);
         createGroupsFromXmlList(_loc9_,var_615,param1,param2,var_201,var_271);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_135,var_519,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1562,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1327) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1562,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1327) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_135,var_519);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_135,var_519);
         }
      }

package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_772:uint = 4284532064;
      
      private static const const_771:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_173)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_963)
            {
            ...
            var_356.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_387);
            var_356.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1525 == null)
         {
            var_1525 = createMinimizedWindow();
         }
         if(!var_2075)
         {
            return var_62;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_62)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_772) : uint(const_771);
            }

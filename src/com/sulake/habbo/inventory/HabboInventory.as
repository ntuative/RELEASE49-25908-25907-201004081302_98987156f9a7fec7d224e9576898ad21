package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_880:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_442,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_618));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_45.getValue(InventoryCategory.const_76));
      }
      ...
      {
         var_107.clubPeriods = param1;
         var_107.clubDays = param2;
         var_107.clubHasEverBeenMember = param3;
         var_107.isVIP = param4;
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_139));
      }
      ...
      {
         return AchievementsModel(var_45.getValue(InventoryCategory.const_313));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_881.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_881.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_107.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_45.getValue(InventoryCategory.const_283) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1059 = new IncomingMessages(this);
      ...
      {
         return var_107.clubHasEverBeenMember;
      }
      
      public function get method_6() : int
      {
         return var_107.method_6;
      }
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_251));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_442,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_283,_loc3_);
         ...
         var_45.add(InventoryCategory.const_313,_loc7_);
         ...
         var_45.add(InventoryCategory.const_139,_loc10_);

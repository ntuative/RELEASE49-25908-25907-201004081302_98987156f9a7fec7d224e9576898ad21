package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_510 = new Timer(const_1100,1);
         var_510.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_687)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_510 != null)
            {
               var_510.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_510.stop();
               var_510 = null;
            }
            if(var_134 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_173)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_736 == null)
         {
            var_736 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_736.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_246:
               ...
               break;
            case InventorySubCategory.const_987:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_283);
         ...
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_329:
                  var_47.toggleInventoryPage(InventoryCategory.const_139);
            }
         }
      }
      ...
      {
         if(var_894 && param1.type == RoomEngineObjectEvent.const_220)
         {
            var_47.showView();
            var_894 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_319 || _loc3_.category == FurniCategory.const_317 || _loc3_.category == FurniCategory.const_281)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_429 = new Map();
         var_429.add(const_42,new Array());
         var_429.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }

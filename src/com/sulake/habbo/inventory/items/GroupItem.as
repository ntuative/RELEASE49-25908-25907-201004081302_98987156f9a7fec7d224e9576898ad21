package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1630:int = 13421772;
      ...
      protected var var_378:BitmapData;
      
      private const const_1431:Number = 0.2;
      
      protected var var_1387:Boolean;
      
      private const const_1430:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_687)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1431;
               _loc1_.blend = const_1431;
            }
            else
            {
               _window.blend = const_1430;
               _loc1_.blend = const_1430;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1387 && getRecyclableCount() > 0)
            {

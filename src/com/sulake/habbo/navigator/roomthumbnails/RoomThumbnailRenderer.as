package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_746:int = 32;
      
      private static const const_1035:int = 8;
      
      public static const const_407:int = 10;
      
      private static const const_1036:int = 40;
      ...
      private var var_791:ThumbnailImageConfigurations;
      
      private var var_1136:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_791 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_791.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1037,_loc4_.y + const_1036 - _loc5_.height),null,null,true);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_791.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_791.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_791.getImage(ThumbnailEditorModel.const_54,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_746 / 2);
         return new Point(param1 * const_746 + _loc3_,param2 * const_1035);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_407)
         {
            if(false)
            {
               refreshObj(param1,var_970[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1136 == null)
         {
            var_1136 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1136,var_1136.rect,new Point(0,0),null,null,true);
      }
   }
}

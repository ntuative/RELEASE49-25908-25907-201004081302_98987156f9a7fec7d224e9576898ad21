package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1488,this._model.mode != ThumbnailEditorModel.const_54);
         setEnabled(var_1487,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1488 = IButtonWindow(find("top_tab"));
         var_1487 = IButtonWindow(find("obj_tab"));
         var_1989 = IWindowContainer(find("tile_grid"));
         var_1988 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1488,onTopTabButton);
         Util.setProcDirectly(var_1487,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1989;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1988;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_60,HabboWindowStyle.const_39,HabboWindowParam.const_70,new Rectangle(0,0,param1.width,66)));

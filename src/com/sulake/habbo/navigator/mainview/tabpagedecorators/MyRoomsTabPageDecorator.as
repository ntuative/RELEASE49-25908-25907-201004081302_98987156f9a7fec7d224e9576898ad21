package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_531:IDropMenuWindow;
      ...
      {
         var _loc1_:int = var_531 == null ? 0 : int(var_531.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_531 == null)
         {
            var_531 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_531.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }

package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private function prepare() : void
      {
         ...
         var_1086 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_60,HabboWindowStyle.const_39,HabboWindowParam.const_70,new Rectangle(0,0,100,300)));
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1349 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1349 = true;
            _loc3_.y = 1;

package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1218:TextFieldManager;
      ...
      private var var_1215:TextFieldManager;
      
      private var var_495:Boolean;
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1215.clearErrors();
         this.var_905.clearErrors();
         this.var_906.clearErrors();
         this.var_1021.clearErrors();
         this.var_1218.clearErrors();
      }
      ...
      private function populateForm() : void
      {
         ...
         var_837.setText(_loc1_.name);
         var_1215.setText(_loc1_.description);
         var_1021.setText("");
         var_1218.setText("");
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_60,HabboWindowStyle.const_39,HabboWindowParam.const_70,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1908.visible = var_495;
         var_1907.visible = !var_495;
         if(var_495)
         {
            var_1024.visible = true;
            var_1213.visible = false;
         ...
         else
         {
            ...
            var_1213.visible = true;
            var_1216.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1216.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1025.height = Util.getLowestPoint(this.var_1025) + 4;
         }
         var_1467.text = !!var_495 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1464.name,var_1216.name,var_1025.name,var_1024.name,var_1213.name,var_1466.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_837.getText();
         _loc2_.description = var_1215.getText();
         ...
         {
            _loc8_ = var_1021.getText();
            _loc9_ = var_1218.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1021.clearErrors();
               this.var_1218.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1212.isSelected;
         _loc2_.allowFoodConsume = var_1217.isSelected;
         _loc2_.allowWalkThrough = var_1214.isSelected;
         _loc2_.tags = new Array();
         addTag(var_905,_loc2_.tags);
         addTag(var_906,_loc2_.tags);
         this.clearErrors();
         this.var_1023 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_410 || var_1023 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_837.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1348)
         {
            this.var_837.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1178)
         {
            this.var_1215.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         {
            this.var_1021.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_837.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_872,onDoorModePasswordUnselect);
         ...
         this.var_837 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1215 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_905 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_906 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1021 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1218 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1212 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1217 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1214 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1464 = IWindowContainer(_window.findChildByName("header_container"));
         var_1216 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         ...
         var_1466 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1213 = IWindowContainer(_window.findChildByName("footer_container"));
         ...
         var_1907 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1908 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1467 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1467.procedure = onSwitchView;
         var_1022.visible = false;
         if(!_inRoom)
         {

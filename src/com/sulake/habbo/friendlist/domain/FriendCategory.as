package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_238.length / const_324);
      }
      ...
      {
         if(this.var_930 >= this.getPageCount())
         {
            this.var_930 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_930 + 1) * const_324,this.var_238.length);
      }

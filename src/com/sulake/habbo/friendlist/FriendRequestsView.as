package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_337 && _loc4_.state != FriendRequest.const_312)
            {
      ...
      {
         var_1598 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1599 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1599.procedure = onDismissAllButtonClick;
         var_1598.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_337 && _loc4_.state != FriendRequest.const_312)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_272,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_970)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1598,_loc1_);
         setEnabled(var_1599,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_272,param1));
         }
      }
   }
}

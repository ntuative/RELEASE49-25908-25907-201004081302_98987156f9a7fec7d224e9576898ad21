package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1423:OpenedToWebPopup;
      
      private var var_795:IAvatarRenderManager;
      ...
      private var var_1424:AvatarSearchResults;
      ...
      private var var_1752:FriendListLookAndFeel;
      ...
      {
         var_1752 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_87 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1424 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_337.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_337.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_445.findTab(FriendListTab.const_89).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_337 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_87.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_87.addCategory(new FriendCategory(FriendCategory.const_852,getText("friendlist.friends")));
         var_87.addCategory(new FriendCategory(FriendCategory.const_447,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_87.addFriend(new Friend(_loc4_));
         }
         var_445 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_471)
         {
            var_471 = new Timer(120000);
            var_471.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_471.start();
         }
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_471.stop();
            var_471.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_471 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_795)
         {
            var_795.release(new IIDAvatarRenderManager());
            var_795 = null;
         }
         if(var_806)
         {
            var_806.release(new IIDHabboNotifications());
            var_806 = null;
         }
         if(var_195)
         {
         ...
         if(var_567)
         {
            var_567.release(new IIDSessionDataManager());
            var_567 = null;
         }
         super.dispose();
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_445.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_296));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1424.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_337.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_567.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_567.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_337.limit)
         {
            var_337.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_445.findTab(FriendListTab.const_89);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_795.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_337.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_445.findTab(FriendListTab.const_89);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1423 == null)
         {
            var_1423 = new OpenedToWebPopup(this);
         }
         var_1423.show(x,y);
      }

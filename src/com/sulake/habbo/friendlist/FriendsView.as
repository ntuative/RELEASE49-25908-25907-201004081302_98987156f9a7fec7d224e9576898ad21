package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_710:String = "bg";
      ...
      {
         var_1862 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1864 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1863 = initButton("room_invite",onInviteButtonClick,param1);
         var_1865 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_710);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_356.method_2(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1862,isEnableMinimailButton(_loc1_));
         setEnabled(var_1864,isEnableHomeButton(_loc1_));
         setEnabled(var_1863,isEnableInviteButton(_loc1_));
         setEnabled(var_1865,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_710);

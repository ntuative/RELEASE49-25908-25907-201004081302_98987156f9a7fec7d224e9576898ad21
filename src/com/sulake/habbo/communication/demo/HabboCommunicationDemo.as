package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1876:PseudoRandom;
      ...
      private const const_1415:String = "fuselogin";
      
      private var var_292:ICoreCommunicationManager;
      
      private var var_404:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1157:
            case DisconnectReasonEvent.const_1137:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1175:
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_692 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_692);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1201,var_1877));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1415,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_404.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_404.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1876);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1415,"/");
      ...
      {
         var_692 = _habboConfiguration.getKey("sso.ticket",null);
         var_1201 = _habboConfiguration.getKey("flash.client.url","");
         var_1877 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_165 == null)
         {
         ...
         if(var_692 != null)
         {
            var_63.mode = HabboConnectionType.const_397;
            var_63.initConnection(HabboConnectionType.const_237);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_574);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1876 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_397:
               _loc6_ = "";
               ...
               var_1004 = _loc4_;
               var_165.loadBannerImage(_loc7_ + "?token=" + var_1004,onHotelViewBannerLoaded);
               break;
            ...
            case HabboConnectionType.const_1245:
               ...
               var_404 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_404.init(var_582);
               _loc8_ = var_404.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1004);
         ...
         var_404 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_404.init(_loc14_);
            _loc15_ = var_404.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_63.mode = HabboConnectionType.const_841;
            }
         }
         var_63.initConnection(HabboConnectionType.const_237);
      }

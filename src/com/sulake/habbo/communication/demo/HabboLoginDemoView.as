package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_530:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_109.removeEventListener(SSOTicket.const_334,onParsedTicketSuccess);
         var_109.removeEventListener(SSOTicket.const_275,onParsedTicketFailure);
         var_109 = null;
         dispatchEvent(new Event(const_530));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1415,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_342.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_454,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1415,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_109.addEventListener(SSOTicket.const_334,onParsedTicketSuccess);
         var_109.addEventListener(SSOTicket.const_275,onParsedTicketFailure);
      }

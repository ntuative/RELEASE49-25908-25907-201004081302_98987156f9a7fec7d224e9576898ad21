package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_424:UserInfoCtrl;
      
      private var var_59:ModerationManager;
      
      private var var_1053:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_424 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_1053 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_424.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_115.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1053.load(_loc4_,var_115.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_876,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_424 = new UserInfoCtrl(_window,var_59,_loc3_.message);
            var_424.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }

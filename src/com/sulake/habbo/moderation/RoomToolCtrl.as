package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_643,_data.flatId),var_51,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_410);
         if(param1.flatId != var_410)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_410);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_699.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1306,_loc2_,var_402.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1017.isSelected,var_1018.isSelected,var_699.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_699 = ICheckBoxWindow(var_51.findChildByName("kick_check"));
         var_1017 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_1018 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_410));
         Logger.log("BEGINNING TO SHOW: " + var_410);
      }
   }
}

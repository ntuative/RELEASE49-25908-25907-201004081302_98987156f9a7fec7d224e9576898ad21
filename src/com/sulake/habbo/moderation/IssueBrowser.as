package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1657:String = "my_issues";
      ...
      private var var_366:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_366.view.width = var_232.container.width;
         var_366.view.height = var_232.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1657:
               if(var_1558 == null)
               {
                  var_1558 = new MyIssuesView(issueManager,this,var_232.container);
               }
               return var_1558;
            case const_1655:
               if(var_1557 == null)
               {
                  var_1557 = new OpenIssuesView(issueManager,this,var_232.container);
               }
               return var_1557;
            case const_1656:
               if(var_1559 == null)
               {
                  var_1559 = new PickedIssuesView(issueManager,this,var_232.container);
               }
               return var_1559;
            default:
               return null;

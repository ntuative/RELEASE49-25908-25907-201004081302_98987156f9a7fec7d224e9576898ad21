package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1887:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1887.clone());
      ...
      {
         var_1887 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1398;
      }
   }
}

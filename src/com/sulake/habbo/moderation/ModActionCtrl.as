package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_824 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_825 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_826.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1193,var_402.text,getBanLength(),var_1194));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_826.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1193,var_402.text,var_1194));
         this.dispose();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1193,var_402.text,var_1194));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            var_51.findChildByName("offence_txt").caption = this.var_686.name;
            var_51.findChildByName("offence_category").visible = true;
         }
         else if(this.var_687 != null)
         {
            this.refreshButtons("offences_cont",2,var_687.offences,var_824,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_825,onOffenceCtgButton);
      ...
      public function show() : void
      {
         ...
         var_51.caption = "Mod action on: " + var_1445;
         ...
         var_826 = IDropMenuWindow(var_51.findChildByName("banLengthSelect"));
         prepareBanSelect(var_826);

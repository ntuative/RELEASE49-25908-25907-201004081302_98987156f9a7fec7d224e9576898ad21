package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_483:String = "tab_girl";
      
      private const const_484:String = "tab_boy";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(_model.controller.gender)
         {
            case FigureData.const_79:
               activateTab(const_484);
               inactivateTab(const_483);
               break;
            case FigureData.const_88:
               activateTab(const_483);
               inactivateTab(const_484);
         }
      }

package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1438:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var_1438 = new AvatarSet(param1.avatarset[0]);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(var_481,var_820,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1438.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_123[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1438.findAvatarSet(param1);
         if(_loc3_ != null)
         {

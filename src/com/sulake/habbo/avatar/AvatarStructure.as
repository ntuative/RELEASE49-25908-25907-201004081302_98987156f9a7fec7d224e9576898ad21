package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2038:PartOffsetData;
      
      private var var_863:AvatarActionManager;
      
      private var var_171:IAssetLibrary;
      
      private var var_1047:IAssetLibrary;
      
      private var var_2037:AvatarRenderManager;
      
      private var var_310:FigureData;
      ...
      private var var_1507:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_171 = param2;
         var_1047 = param3;
         var_310 = new FigureData();
         var_421 = new PartSetsData();
         _animationData = new AnimationData();
         var_1507 = new AvatarStructureDownloadSet();
         var_721 = new AnimationManager();
         var_720 = param4;
         var_2038 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_863.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_863.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_310.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_863.getActionDefinition(param1);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1300[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_863.getDefaultActionType();
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_310.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_310.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_720 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_720)
         {
            case AvatarType.const_81:
               ...
               var_1507.add(new AvatarStructureDownload(var_171,_loc5_,var_310));
               break;
            case AvatarType.PET:
         }
         var_1507.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_863 = new AvatarActionManager(var_171,var_720);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1271 = var_310.getMandatorySetTypeIds();
         return var_1271;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_310.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1047.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1047.getAssetByName("dance" + _loc1_).content as XML;
            var_721.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1047.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1047.getAssetByName("fx" + _loc1_).content as XML;
            var_721.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_2038.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_310.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_310.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_863.sortActions(param1);
      }
   }
}

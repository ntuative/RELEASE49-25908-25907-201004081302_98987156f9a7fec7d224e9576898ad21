package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_698.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_698.getValue(param1) as IPetData;
      }
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_698.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_698.getValue(key);
            if(petData != null)
            {
      ...
      {
         var _loc4_:PetData = var_698.getValue(param1);
         if(_loc4_ == null)
         {

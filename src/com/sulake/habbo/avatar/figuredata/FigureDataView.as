package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_968 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_355 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_355 && var_968)
         {
            var_355.bitmap = new BitmapData(var_355.width,var_355.height,true,16777215);
            var_355.bitmap.copyPixels(var_968,var_968.rect,new Point(0,0 - 0 - 8));
            var_355.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}

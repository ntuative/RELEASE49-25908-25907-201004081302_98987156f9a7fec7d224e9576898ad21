package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_740:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_741 = _loc4_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_741.width,var_741.height,true,0);
            _loc1_.bitmap.copyPixels(var_741,var_741.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_ = var_897.clone();
            _loc5_.colorTransform(_loc5_.rect,var_740.colorTransform);

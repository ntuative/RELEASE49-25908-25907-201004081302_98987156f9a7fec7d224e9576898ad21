package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1268:IProductData;
      ...
      {
         super();
         var_1270 = param1.productType;
         var_1267 = param1.furniClassId;
         var_1043 = param1.extraParam;
         var_1044 = param1.productCount;
         var_1269 = param1.expiration;
         var_1268 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_82:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1043);
               break;

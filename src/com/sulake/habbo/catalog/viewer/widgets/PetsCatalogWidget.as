package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_381 >= var_289.length)
         {
            return "";
         }
         var petColor:IPetColor = var_289[var_381] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_550[var_1396] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_381 < 0 || var_381 > var_289.length)
         {
            var_381 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_557.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         var_774 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_289 = [];
         var_550 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_774);
               if(_loc11_)
               {
         ...
         while(_loc6_ < var_550.length)
         {
            ...
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_774,_loc12_.id),getRaceLocalizationKey(var_774,_loc12_.id)));
            _loc6_++;
         }
         var_557.add(var_774,_loc5_);
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_557.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_381 >= 0 && var_381 < var_289.length)
         {
            _loc7_ = var_289[var_381] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_550[var_1396] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_774,_loc3_.id,_loc2_,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_310,AvatarAction.const_731);

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1000:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_999 != null)
         {
            var_999.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1000 != null)
         {
            var_1000.removeEventListener(WindowKeyboardEvent.const_146,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_999 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_999 != null)
         {
            var_999.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1000 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1000 != null)
         {
            var_1000.addEventListener(WindowKeyboardEvent.const_146,windowKeyEventProcessor);
         }
      }

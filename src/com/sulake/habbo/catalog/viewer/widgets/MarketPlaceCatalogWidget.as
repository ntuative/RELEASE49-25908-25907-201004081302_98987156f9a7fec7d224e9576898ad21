package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_780:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         if(!var_459)
         {
            ...
            var_459 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_459)
         {
            return;
         ...
         if(!var_387)
         {
            var_387 = new Timer(25);
            var_387.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_779 = 0;
         populateList();
         var_387.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_557)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_459 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_459.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_388.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_387)
         {
            var_387.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_387 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_779 >= var_557.length)
            {
               return true;
            }
            addListItem(var_557.getWithIndex(var_779));
            ++var_779;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_780.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_388));
            _loc7_.selection = 0;
         }
      }

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = var_553[var_960][var_1639];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_441 || _loc1_.pricingModel == Offer.const_360)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_80)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_961.indexOf(_loc5_) == -1)
                        {
                           var_961.push(_loc5_);
                           var_553.push(new Array());
                        }
                        _loc6_ = var_961.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_553)
         {
            if(var_1639 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1639] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_960 = var_950.getGridItemIndex(param1.view);

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1145:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1237.text = "${" + _loc3_.name + "}";
            var_1236.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1237.text = "${" + _loc2_.localizationId + "}";
            var_1236.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_367:
                  _loc4_ = var_1144.clone();
                  if(var_562 != null)
                  {
                     var_562.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_562,var_1145,var_1139);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_218:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_310,AvatarAction.const_556);
      ...
      {
         var_1237 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1236 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1416 = new Point(var_81.x,var_81.y);
         var_562 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1145 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_562 == null)
         {
         ...
         var_1144 = _loc2_.content as BitmapData;

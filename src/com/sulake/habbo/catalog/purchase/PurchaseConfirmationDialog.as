package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1654:uint = 4.291613146E9;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_885;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_885,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_449,var_76,var_1064);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_260) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_885);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_607[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_606[var_199]);
         _catalog.purchaseProductAsGift(var_449,var_76,var_1064,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_260) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_260);
         }
         var_260 = param1;
         if(var_260 < 0)
         {
            var_260 = _loc2_.numListItems - 1;
         }
         if(var_260 >= _loc2_.numListItems)
         {
            var_260 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_260) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_509 == null)
         {
            var_509 = createWindow("suggestion_list_item") as IWindowContainer;
            var_509.procedure = suggestionsEventHandler;
         }
         if(var_230 == null || var_509 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_230.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_509.clone() as IWindowContainer;
            if(_loc5_ != null)
            {

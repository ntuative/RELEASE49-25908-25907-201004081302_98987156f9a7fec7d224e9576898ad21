package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2243:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1562,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2062 || param1.furniTypeId != var_2063)
         {
            return;
         }
         var_2243 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1569,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2060 = _loc3_.creditsWaiting;
         var_205 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_188)
         {
            var_188 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_188.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2242,var_2241,var_1763,var_2240);
      }

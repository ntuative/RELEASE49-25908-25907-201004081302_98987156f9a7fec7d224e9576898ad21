package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1075:String = "tile_cursor";
      ...
      private var var_268:IAdManager = null;
      ...
      private var var_702:RoomMessageHandler = null;
      
      private var var_703:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_702 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_64 != null)
         {
            ...
            {
               return var_64.deleteWallItem(var_111,var_112,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_560) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_664) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_527) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_700) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_64.modifyWallItemData(var_111,var_112,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_703 != null)
         {
            var_703.release(new IIDRoomRendererFactory());
            var_703 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_519);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_626);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_668);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_946);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_840) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_896);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_464,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_637,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_665,var_111,var_112,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            return var_64.modifyRoomObject(var_111,var_112,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_653,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_39 != null)
         {
            ...
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_65);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_64 != null)
         {
            var_64.handleRoomObjectEvent(param1,var_111,var_112);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_205,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_964,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_799,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      {
         if(var_26 == null || var_406 == null || var_39 == null || var_703 == null || _communication == null || _habboConfiguration == null || !var_1916)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_276,RoomObjectCategoryEnum.const_65);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1180,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_39.getRoom(getRoomIdentifier(var_111,var_112));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1222);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1222);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_406;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_213,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_355,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_630,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_402,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_422,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_426,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectMoveEvent.const_475,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_456,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_266,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_368,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_287,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_282,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_466,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_801,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_415,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_384,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_733) != 0)
         {
            return false;
         }
         if(var_64 != null)
         {
            return var_64.initializeRoomObjectInsert(var_111,var_112,param1,param2,param3,param4);
         }
         return false;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_205));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_455);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_338);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_552)
         {
            var_1916 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_205,_loc10_,false);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_268.events.addEventListener(AdEvent.const_364,showRoomAd);
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_703 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_39.getRoom(const_486);
         if(_loc10_ == null)
         {
            _loc10_ = var_39.createRoom(const_486,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_29:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_205,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_455,param8);
               break;
            case RoomObjectCategoryEnum.const_35:
            ...
            case RoomObjectCategoryEnum.const_65:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_585,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_688,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_639,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_464,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         if(!isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1010,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_762,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
         ...
         if(_loc9_ != null)
         {
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_443,var_111,var_112,-1,RoomObjectCategoryEnum.const_199));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_64 != null)
               {
                  ...
                  var_64.handleRoomObjectEvent(_loc14_,var_111,var_112);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1222);
         if(_loc7_ != null)
         {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_818,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_917,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_980,RoomObjectVariableEnum.const_293,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_552,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_64 != null)
         {
            var_64.cancelRoomObjectInsert(var_111,var_112);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_39.getRoom(const_486);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1010);
      ...
      {
         return getRoomObjectBoundingRectangle(var_111,var_112,const_276,RoomObjectCategoryEnum.const_65,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_863,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_733,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_962,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_276,const_487,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_733,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_519,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_560,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_527,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_664,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_700,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_816,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_653,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_737,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_464,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_197);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_946,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_762,const_1075,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);

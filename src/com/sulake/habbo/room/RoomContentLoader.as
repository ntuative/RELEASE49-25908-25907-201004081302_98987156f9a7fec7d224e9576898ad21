package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_780:String = "selection_arrow";
      ...
      private static const const_1107:String = const_349;
      ...
      public static const const_552:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_521 = [];
         var_522 = [];
         var_2166 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2164 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_431 = new Map();
         _events = new Map();
      ...
      {
         if(var_179 != null && var_179.method_7(const_278 + param1))
         {
            return var_179.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_522.indexOf(_loc14_) < 0)
                              {
                                 var_522.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_431 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_431.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_431.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_617.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_431.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_349,const_489,ROOM_CONTENT,const_782,const_780];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2166.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_157 && _loc5_ != RoomObjectLogicEnum.const_117)
         {
            _loc6_ = "@shadow";
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_522.indexOf(param1) >= 0)
         {
            return const_489;
         }
         if(var_179 != null && (var_179.type == param1 || var_179.method_7(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1107;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_618.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1217);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2164.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_401,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_2165)
         {
            ...
            if(var_1080 != null)
            {
               var_1080.dispatchEvent(new Event(const_552));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_179 != null)
         {
            return var_179.getWorldHeightScale(const_278 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1080 = param1;
            var_2167 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2161 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2163 = param2.getKey("public.room.dynamic.download.url","");
            var_2162 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_781;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_430 != null)
         {
            var_430.remove(param1);
            var_430.add(param1,param2);
         }
         if(var_432 != null)
         {
            var_432.remove(param2);
            var_432.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_157 && _loc5_ != RoomObjectVisualizationEnum.const_117)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_179 = var_1332.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_383,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_179 != null)
         {
            return var_179.getWorldScale(const_278 + param1);
         }
         return 32;
      }

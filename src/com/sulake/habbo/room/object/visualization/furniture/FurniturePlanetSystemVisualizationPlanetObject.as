package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var_674 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1120 = param3;
         var_1798 = param4 * 0 * 2 / 360;
         var_1431 = param5 * 0 * 2 / 360;
         _height = param6;
         var_813 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1120 * Math.cos(var_813 + var_1431);
         var _loc4_:Number = var_1120 * Math.sin(var_813 + var_1431);
         var _loc5_:Number = _height;
         var_674.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_674.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_674.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_674.add(param1);
         }

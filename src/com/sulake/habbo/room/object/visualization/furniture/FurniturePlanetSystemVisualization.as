package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_919);
      ...
      {
         if(param1 < var_584.length)
         {
            return var_584[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_223 != null)
         {
            ...
            {
               _loc2_ = var_223[_loc3_];
               _loc2_.update(var_584,var_1888,param1);
               _loc3_++;
            }

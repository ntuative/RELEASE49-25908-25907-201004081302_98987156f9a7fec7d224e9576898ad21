package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_404,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setNumber(RoomObjectVariableEnum.const_404,Number(false));
         var_815 = true;
      }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_980:
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_404,Number(true));
                  var_1040 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_962);
            }
         }
      }

   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_573:
                  _loc2_.setString(RoomObjectVariableEnum.const_585,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_653:
                  _loc2_.setString(RoomObjectVariableEnum.const_688,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_737:
                  _loc2_.setString(RoomObjectVariableEnum.const_639,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_464:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_197)
                  {
                     _loc8_ = "null";
                  }
                  var_395.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_637:
                  _loc7_ = var_395.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_395.getXML();
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_825,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_726,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc9_:IVector3d = var_75.method_3(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1274,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1366,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1135,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_147 || _loc13_ == RoomPlaneData.const_257)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_782)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_726,_loc3_);
         }
      }
   }
}

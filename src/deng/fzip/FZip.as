package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_507 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_583))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_583,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_92 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_583,"EOF"));
            }
         }
      }
      ...
      {
         if(var_507.parse(param1))
         {
            var_46.push(var_507);
            if(false)
            {
               var_133["null"] = var_507;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1168,var_507));
            var_507 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_133 != null && param1 < var_46.length)
         {
